...
# Load saved files (Updated names)
...
# --- NEW: Safety check ---
# If the user enters words the model has never seen, the vector is empty.
if text_vector.sum() == 0:
    print("\nI don't recognize those specific skills. Try using different keywords or adding more detail!")
else:
    # Predict
    prediction = model.predict(text_vector)[0]
